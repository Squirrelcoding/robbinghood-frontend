...
export const metadata: Metadata = {
  title: "Next.js Buttons | RobbingHood - Next.js Dashboard Template",
  description:
    "This is Next.js Buttons page for RobbingHood - Next.js Tailwind CSS Admin Dashboard Template",
};

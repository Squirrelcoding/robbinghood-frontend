...
export const metadata: Metadata = {
  title: "Next.js Avatars | RobbingHood - Next.js Dashboard Template",
  description:
    "This is Next.js Avatars page for RobbingHood - Next.js Tailwind CSS Admin Dashboard Template",
};
